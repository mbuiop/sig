...
def index():
    ...
    <head>
        ...
        <title>🚀 سیستم حسابداری آنلاین فوق مدرن</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <header>
                <h1>🚀 سیستم حسابداری آنلاین فوق مدرن</h1>
                <div class="subtitle">یک پلتفرم کامل برای مدیریت مالی، فاکتور، مشتریان و چت</div>
                <div class="status" id="status">✅ سرور فعال و در حال اجرا</div>
            </header>
            
            <div>
                <a href="/api/system/health" class="btn" target="_blank">بررسی وضعیت سرور</a>
                <a href="/api/auth/send-otp" class="btn" style="background: linear-gradient(to right, #f093fb 0%, #f5576c 100%);">ثبت‌نام / ورود</a>
                <a href="#api-list" class="btn" style="background: linear-gradient(to right, #43e97b 0%, #38f9d7 100%);">API ها</a>
            </div>
            ...
            <div class="feature-grid">
                <div class="feature">
                    ...
                    <p>OTP، JWT، رمزنگاری پیشرفته AES-256-CBC</p>
                </div>
                <div class="feature">
                    <div class="feature-icon">🧾</div>
                    <h3>مدیریت فاکتور</h3>
                    <p>ایجاد، ویرایش، چاپ فاکتور با QR Code</p>
                </div>
                <div class="feature">
                    <div class="feature-icon">💬</div>
                    <h3>چت آنلاین</h3>
                    <p>WebSocket برای ارتباط زنده با مشتریان</p>
                </div>
                <div class="feature">
                    <div class="feature-icon">📊</div>
                    <h3>گزارش‌گیری</h3>
                    <p>گزارشات مالی و تحلیلی پیشرفته</p>
                </div>
            </div>
            
            <div class="test-info">
                <h3>🧪 تست سریع سیستم</h3>
                <p>شماره تست: <strong>09123456789</strong></p>
                <p>کد OTP تست: <strong>12345</strong></p>
                <p>از Postman یا curl برای تست API استفاده کنید</p>
            </div>
            
            <div class="api-list" id="api-list">
                <h2>📡 لیست API های اصلی</h2>
                
                <div class="api-item">
                    <span class="method post">POST</span>
                    <strong>/api/auth/send-otp</strong>
                    <p>ارسال کد OTP به شماره تلفن</p>
                    <small>پارامترها: {"phone": "09123456789"}</small>
                </div>
                
                <div class="api-item">
                    <span class="method post">POST</span>
                    <strong>/api/auth/verify-otp</strong>
                    <p>تایید کد OTP و دریافت توکن</p>
                    <small>پارامترها: {"phone": "...", "code": "12345"}</small>
                </div>
                
                <div class="api-item">
                    <span class="method get">GET</span>
                    <strong>/api/user/profile</strong>
                    <p>دریافت پروفایل کاربر (نیاز به توکن)</p>
                ...
                <div class="api-item">
                    ...
                    <p>دریافت لیست مشتریان (نیاز به توکن)</p>
                </div>
                
                <div class="api-item">
                    <span class="method post">POST</span>
                    <strong>/api/invoices</strong>
                    <p>ایجاد فاکتور جدید (نیاز به توکن)</p>
                </div>
                
                <div class="api-item">
                    <span class="method get">GET</span>
                    <strong>/api/transactions</strong>
                    <p>دریافت تراکنش‌ها (نیاز به توکن)</p>
                </div>
                
                <div class="api-item">
                    <span class="method get">GET</span>
                    <strong>/api/system/health</strong>
                    <p>بررسی وضعیت سلامت سرور</p>
                </div>
            </div>
            
            <footer>
                <p>© 2024 سیستم حسابداری آنلاین | نسخه 1.0.0</p>
                <p>آدرس سرور: <code id="serverUrl">http://localhost:5000</code></p>
                <p>WebSocket: <code>ws://localhost:5000</code></p>
                <p>برای تست از Postman یا curl استفاده کنید</p>
            </footer>
        </div>
        
        <script>
            // آدرس سرور را به صورت خودکار تنظیم کن
            ...
            ws.onopen = () => {
                document.getElementById('status').textContent = '✅ سرور فعال - WebSocket متصل';
                document.getElementById('status').style.background = 'rgba(76, 175, 80, 0.3)';
                ws.close();
            };
            
            ws.onerror = () => {
                document.getElementById('status').textContent = '⚠️ WebSocket در دسترس نیست';
...
def api_docs():
    ...
    <body>
        <div class="container">
            ...
            <h1>📚 مستندات API سیستم حسابداری</h1>
            
            <h2 id="auth">🔐 احراز هویت</h2>
  ...
  "code": "12345"
            ...
            <h2 id="customers">👥 مشتریان</h2>
            
            <div class="endpoint">
                <span class="method get">GET</span>
                <span class="path">/api/customers</span>
                <p>دریافت لیست مشتریان (نیاز به توکن)</p>
                <p><strong>هدر:</strong> Authorization: Bearer &lt;token&gt;</p>
            </div>
            
            <h2 id="invoices">🧾 فاکتورها</h2>
            
            <div class="endpoint">
                <span class="method post">POST</span>
                <span class="path">/api/invoices</span>
                <p>ایجاد فاکتور جدید</p>
                <pre>{
  "customer_id": 1,
  "items": [
    {
      ...
      "unit_price": 50000
            ...
            <div class="endpoint">
                ...
                <p>بررسی وضعیت سلامت سرور</p>
                <pre>curl {window.location.origin}/api/system/health</pre>
            </div>
            
            <footer>
                <p>© 2024 سیستم حسابداری آنلاین | <a href="/">بازگشت به صفحه اصلی</a></p>
                <p>آدرس API پایه: <code>{window.location.origin}/api/</code></p>
            </footer>
        </div>
        
        <script>
            // جایگزینی آدرس سرور در مثال‌ها
            document.querySelectorAll('pre').forEach(pre => {
                pre.textContent = pre.textContent.replace('{window.location.origin}', window.location.origin);
            });
        </script>
    </body>
    </html>
...
if __name__ == '__main__':
    ...
    print("📚 مستندات: http://localhost:5000/api/docs")
